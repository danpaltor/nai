...
<p align="center">
  ...
  <img src="https://img.shields.io/github/license/danpaltor/nai?style=for-the-badge">
  <img src="https://img.shields.io/github/issues/danpaltor/nai?color=violet&style=for-the-badge">
  <img src="https://img.shields.io/github/stars/danpaltor/nai?style=for-the-badge">
  <img src="https://img.shields.io/github/forks/danpaltor/nai?color=teal&style=for-the-badge">
</p>
...
- Get the script: `git clone https://github.com/danpaltor/nai.git`

### Without git
- Increase cowspace partition: `mount -o remount,size=2G /run/archiso/cowspace`
- Get the script: ` wget https://github.com/danpaltor/nai/tarball/master -O - | tar xz`
    ...
    - super short `wget ow.ly/wnFgh -O nai.zip`

## How to use
- NAIS [System Base]: `cd nai ; ./nais`
- BNAI [The Rest]: `cd nai ; ./bnai`
...
## Thank danpaltor
If you like my work, please consider a small Paypal donation at danielpalumbi@gmail.com :)
